                        ...
                        <tr class="fw-bold">
                            ...
                            <p class="text-end">
                                ...
                                if ($value['trang_thai'] == 0  || $value['trang_thai'] == 1) {
                                    echo '<button class="btn btn-danger btn-sm ms-2" onclick="huyDon(' . $_GET['id_don'] . ',1)">Hủy Đơn</button>';
                                } elseif ($value['trang_thai'] == 2) {
                                    echo '<button class="btn btn-danger btn-sm ms-2" onclick="huyDon(' . $_GET['id_don'] . ',2)">Đã Nhận</button>';
                                } else {
