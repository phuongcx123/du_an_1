<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://localhost/duan1_lo/index.php">
                <div class="sidebar-brand-icon ">

                    <img src="../assets/admin/img/logo.jpg" alt="logo" class="img-profile rounded-circle" width="65">
                </div>
                <div class="sidebar-brand-text mx-3">TPT Store </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Chức năng:</h6>
                        <a class="collapse-item" href="?act=listcolor">Danh Sách</a>
                        <a class="collapse-item" href="?act=listcolor">Thống Kê</a>
                    </div>
                </div>
            </li>
            <!-- bình luận -->
            <li class="nav-item">
                ...
                <div id="collapseTwo4" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Chức năng:</h6>
                        <a class="collapse-item" href="?act=binhluan">Danh Sách</a>
                        <a class="collapse-item" href="?act=sldanhmuc">Thống Kê</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Chức năng:</h6>
                        <a class="collapse-item" href="?act=taikhoan">Danh sách</a>
                        <a class="collapse-item" href="?act=capnhattk">Cập Nhật  Tài Khoản</a>
